...
BASIC_CFLAGS="-Wall -Wno-format -I/usr/local/include/ \
              -I/opt/local/include/ -I/usr/include/mysql -DVERSION=\"$VERSION\" $CFLAGS"

BASIC_LDFLAGS="-L/usr/local/lib/ -L/opt/local/lib -L/usr/lib64/mysql  $LDFLAGS"
...
if [ "$OSTYPE" = "cygwin" ]; then
  ...
  USE_LIBS="-lpcap -lmysqlclient $LIBS"
fi
